...
\begin{enumerate}
    ...
    \item Define the notions of {\em uncertainty} and {\em estimation imprecision} in individual studies or subpopulation-specific results, and contrast this type of variation with {\em heterogeneity} in the true values of a parameter in different studies or subpopulations.
...
In much of statistics, we often downplay the reality that standard errors are estimated rather than exact. For sufficiently large samples this may be fine, but in some settings where data integration is to be carried out, the individual estimates may be based on small samples, and/or the number of estimates to be integrated may be small. For this reason, it is appropriate to consider the consequences of using plug-in variance estimates in the procedures discussed above.  This topic, along with other more advanced aspects of evidence pooling are discussed in detail \href{https://onlinelibrary.wiley.com/doi/epdf/10.1002/sim.6632}{here}.
