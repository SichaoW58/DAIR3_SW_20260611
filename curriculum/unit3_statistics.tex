...
\item You will be able to explain the different ways that an auxiliary variable can enter an analysis, such as being confounders and precision variables, and you will recognize when an auxiliary variable is likely to introduce confounding bias.
...
\item You will be able to explain how certain forms of bias can be reduced or eliminated analytically, while others cannot.
