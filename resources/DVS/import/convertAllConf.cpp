//convertAllConf.cpp by: Derek Onken 6/16/15
//updated version of convertAll.cpp
...
string inputFile = "TextFile1.txt";
...
//double duration = (clock()-start)/(double) CLOCKS_PER_SEC;
	...
	std::cout << "number of times post-full is out of bounds = " << error4 << endl;
...
int main(){
	...
	ofstream csv;
	string totalFile = "natalityConf.csv";
	...
	for (i = 1988; i>1968 ; i--){
		...
		ss << (i);
		string year = ss.str();
		parseFile(year, "natalityConf.csv");
